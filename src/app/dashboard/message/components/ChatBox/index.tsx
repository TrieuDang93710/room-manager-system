...
const ChatBox = () => {
  return (
    <div className='relative w-full h-[65vh] bg-blue-900 overflow-y-auto gap-4 p-4'>
      <div className='absolute top-0 left-0 w-full flex items-start justify-start truncate gap-2 px-2 py-2 bg-[#f7f7f7] dark:bg-blue-800 border border-slate-400 border-b-0'>
        <Image
          alt='avatar'
      ...
      <div className='absolute bottom-4 right-0 left-0 w-full flex flex-col items-center justify-start gap-4'>
        <p className='text-white text-[14px] bg-slate-600 dark:bg-[#2525253b] rounded-md px-8 py-1'>Wed 2/4/2025</p>
