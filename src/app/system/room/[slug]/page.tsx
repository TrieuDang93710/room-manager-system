...
const RoomDetailPage = async ({ params }: RoomDetailPageProps) => {
  ...
  const breadcrumbs = [
    ...
    {
      url: `/system/room/${slug}`,
      label: `Room-detail-${slug}`,
  ...
  return (
    ...
    >
      ...
      <div className={'w-full lg:flex-row py-2 ' + flex({ direction: 'col', alignItems: 'start' })}>
        ...
        >
          <h2 className='text-2xl md:text-3xl font-bold py-4 dark:text-green-500'>Room of Information</h2>
          <Button
            variant='outline'
            size='primary'
      ...
      <div className='w-full relative flex flex-col gap-3 px-2 py-2'>
        <h2 className='text-2xl font-bold py-4'>Address in Google Map</h2>
        <GoogleMapsWrapper>
