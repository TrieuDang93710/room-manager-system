'use client';
import { funcOfApplicant, funcOfManager } from '@/config/funcMenuConfig';
import { Role } from '@/enum/role.enum';
import { useAuth } from '@/hooks/auth/useAuth';
import listFuncInterface from '@/interfaces/listFunction';
import Link from 'next/link';
import React, { useEffect, useState } from 'react';
interface ApplicantSystemLayoutProps {
  children: React.ReactNode;
}

const ApplicantSystemLayout = ({ children }: ApplicantSystemLayoutProps) => {
...
export default ApplicantSystemLayout;
