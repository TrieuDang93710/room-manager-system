    ...
    >
      ...
      <div className='sm:w-[80%] w-full flex flex-row items-start justify-around my-4 gap-3'>
        ...
        <div className='w-full flex flex-col items-center justify-start'>
          <div className='w-full h-[10vh] flex sm:flex-row flex-col sm:items-center items-start sm:justify-between justify-start p-4 gap-2'>
            <p className='inline-flex items-center justify-around'>Tìm kiếm theo:</p>
            <ul className='relative w-[80%] sm:h-fit h-full flex flex-row items-center justify-start px-16 gap-4'>
              <Button
                onClick={() => alert('Click me')}
