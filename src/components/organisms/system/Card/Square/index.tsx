...
const CardSquare = ({ children, logo }: CardSquareProps) => {
  return (
    <div className='w-full border-[1px] rounded-sm hover:translate-x-1 cursor-pointer bg-white border-slate-300 hover:border-green-500 flex flex-col items-center justify-center'>
